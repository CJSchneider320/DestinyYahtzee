...
const data = {
  ...
  armors: [
    ...
    //hunter
    { name: "aeon_swift", display: "Aeon Swift", class: "hunter", subclass: ["all"], type: "Gauntlets", img: images.aeon_swift },
    { name: "assassins_cowl", display: "Assassin's Cowl", class: "hunter", subclass: ["all"], type: "Helmet", img: images.assassins_cowl },
    ...
    { name: "foetracer", display: "Foetracer", class: "hunter", subclass: ["all"], type: "Helmet", img: images.foetracer },
    { name: "fr0st_ee5", display: "Fr0st-EE5", class: "hunter", subclass: ["all"], type: "Boots", img: images.fr0st_ee5 },
    { name: "gemini_jester", display: "Gemini Jester", class: "hunter", subclass: ["all"], type: "Boots", img: images.gemini_jester },
    ...
    { name: "knucklehead_radar", display: "Knucklehead Radar", class: "hunter", subclass: ["all"], type: "Helmet", img: images.knucklehead_radar },
    { name: "liars_handshake", display: "Liar's Handshake", class: "hunter", subclass: ["arc"], type: "Gauntlets", img: images.liars_handshake },
    { name: "lucky_pants", display: "Lucky Pants", class: "hunter", subclass: ["all"], type: "Boots", img: images.lucky_pants },
    { name: "mask_of_bakris", display: "Mask of Bakris", class: "hunter", subclass: ["stasis"], type: "Helmet", img: images.mask_of_bakris },
    { name: "mechaneers_tricksleeves", display: "Mechaneer's Tricksleeves", class: "hunter", subclass: ["all"], type: "Gauntlets", img: images.mechaneers_tricksleeves },
    { name: "oathkeeper", display: "Oathkeeper", class: "hunter", subclass: ["all"], type: "Gauntlets", img: images.oathkeeper },
    ...
    { name: "radiant_dance_machines", display: "Radiant Dance Machines", class: "hunter", subclass: ["all"], type: "Boots", img: images.radiant_dance_machines },
    ...
    { name: "sealed_ahamkara_grasps", display: "Sealed Ahamkara Grasps", class: "hunter", subclass: ["all"], type: "Gauntlets", img: images.sealed_ahamkara_grasps },
    ...
    { name: "speedloader_slacks", display: "Speedloader Slacks", class: "hunter", subclass: ["all"], type: "Boots", img: images.speedloader_slacks },
    { name: "st0mp_ee5", display: "St0mp-EE5", class: "hunter", subclass: ["all"], type: "Boots", img: images.st0mp_ee5 },
    { name: "star_eater_scales", display: "Star-Eater Scales", class: "hunter", subclass: ["all"], type: "Boots", img: images.star_eater_scales },
    { name: "the_bombardiers", display: "The Bombardiers", class: "hunter", subclass: ["void"], type: "Boots", img: images.the_bombardiers },
    { name: "the_dragons_shadow", display: "The Dragon's Shadow", class: "hunter", subclass: ["all"], type: "Chestpiece", img: images.the_dragons_shadow },
    { name: "the_sixth_coyote", display: "The Sixth Coyote", class: "hunter", subclass: ["all"], type: "Chestpiece", img: images.the_sixth_coyote },
    { name: "wormhusk_crown", display: "Wormhusk Crown", class: "hunter", subclass: ["all"], type: "Helmet", img: images.wormhusk_crown },
    ...
    { name: "acd0_feedback_fence", display: "ACD/0 Feedback Fence", class: "titan", subclass: ["all"], type: "Gauntlets", img: images.acd0_feedback_fence },
    { name: "actium_war_rig", display: "Actium War Rig", class: "titan", subclass: ["all"], type: "Chestpiece", img: images.actium_war_rig },
    { name: "aeon_safe", display: "Aeon Safe", class: "titan", subclass: ["all"], type: "Gauntlets", img: images.aeon_safe },
    ...
    { name: "antaeus_wards", display: "Antaeus Wards", class: "titan", subclass: ["all"], type: "Boots", img: images.antaeus_wards },
    { name: "armamentarium", display: "Armamentarium", class: "titan", subclass: ["all"], type: "Chestpiece", img: images.armamentarium },
    ...
    { name: "citans_ramparts", display: "Citan's Ramparts", class: "titan", subclass: ["all"], type: "Gauntlets", img: images.citans_ramparts },
    { name: "crest_of_alpha_lupi", display: "Crest of Alpha Lupi", class: "titan", subclass: ["all"], type: "Chestpiece", img: images.crest_of_alpha_lupi },
    ...
    { name: "dunemarchers", display: "Dunemarchers", class: "titan", subclass: ["all"], type: "Boots", img: images.dunemarchers },
    ...
    { name: "heart_of_inmost_light", display: "Heart of Inmost Light", class: "titan", subclass: ["all"], type: "Chestpiece", img: images.heart_of_inmost_light },
    ...
    { name: "icefall_mantle", display: "Icefall Mantle", class: "titan", subclass: ["all"], type: "Gauntlets", img: images.icefall_mantle },
    { name: "khepris_horn", display: "Khepri's Horn", class: "titan", subclass: ["all"], type: "Helmet", img: images.khepris_horn },
    { name: "lion_rampant", display: "Lion Rampant", class: "titan", subclass: ["all"], type: "Boots", img: images.lion_rampant },
    ...
    { name: "mask_of_the_quiet_one", display: "Mask of the Quiet One", class: "titan", subclass: ["all"], type: "Helmet", img: images.mask_of_the_quiet_one },
    ...
    { name: "one_eyed_mask", display: "One-Eyed Mask", class: "titan", subclass: ["all"], type: "Helmet", img: images.one_eyed_mask },
    { name: "peacekeepers", display: "Peacekeepers", class: "titan", subclass: ["all"], type: "Boots", img: images.peacekeepers },
    ...
    { name: "precious_scars", display: "Precious Scars", class: "titan", subclass: ["all"], type: "Helmet", img: images.precious_scars },
    { name: "second_chance", display: "Second Chance", class: "titan", subclass: ["void"], type: "Gauntlets", img: images.second_chance },
    { name: "severance_enclosure", display: "Severance Enclosure", class: "titan", subclass: ["all"], type: "Chestpiece", img: images.severance_enclosure },
    { name: "stronghold", display: "Stronghold", class: "titan", subclass: ["all"], type: "Gauntlets", img: images.stronghold },
    { name: "synthoceps", display: "Synthoceps", class: "titan", subclass: ["all"], type: "Gauntlets", img: images.synthoceps },
    { name: "the_path_of_burning_steps", display: "The Path of Burning Steps", class: "titan", subclass: ["all"], type: "Boots", img: images.the_path_of_burning_steps },
    { name: "ursa_furiosa", display: "Ursa Furiosa", class: "titan", subclass: ["void"], type: "Gauntlets", img: images.ursa_furiosa },
    { name: "wormgod_caress", display: "Wormgod Caress", class: "titan", subclass: ["all"], type: "Gauntlets", img: images.wormgod_caress },

    //warlock
    { name: "aeon_soul", display: "Aeon Soul", class: "warlock", subclass: ["all"], type: "Gauntlets", img: images.aeon_soul },
    { name: "apotheosis_veil", display: "Apotheosis Veil", class: "warlock", subclass: ["all"], type: "Helmet", img: images.apotheosis_veil },
    ...
    { name: "boots_of_the_assembler", display: "Boots of the Assembler", class: "warlock", subclass: ["all"], type: "Boots", img: images.boots_of_the_assembler },
    { name: "chromatic_fire", display: "Chromatic Fire", class: "warlock", subclass: ["all"], type: "Chestpiece", img: images.chromatic_fire },
    { name: "claws_of_ahamkara", display: "Claws of Ahamkara", class: "warlock", subclass: ["all"], type: "Gauntlets", img: images.claws_of_ahamkara },
    ...
    { name: "eye_of_another_world", display: "Eye of Another World", class: "warlock", subclass: ["all"], type: "Helmet", img: images.eye_of_another_world },
    { name: "fallen_sunstar", display: "Fallen Sunstar", class: "warlock", subclass: ["arc"], type: "Gauntlets", img: images.fallen_sunstar },
    { name: "felwinters_helm", display: "Felwinter’s Helm", class: "warlock", subclass: ["all"], type: "Helmet", img: images.felwinters_helm },
    { name: "geomag_stablizers", display: "Geomag Stablizers", class: "warlock", subclass: ["all"], type: "Boots", img: images.geomag_stablizers },
    { name: "getaway_artist", display: "Getaway Artist", class: "warlock", subclass: ["arc"], type: "Gauntlets", img: images.getaway_artist },
    { name: "karnstein_armlets", display: "Karnstein Armlets", class: "warlock", subclass: ["all"], type: "Gauntlets", img: images.karnstein_armlets },
    { name: "lunafaction_boots", display: "Lunafaction Boots", class: "warlock", subclass: ["all"], type: "Boots", img: images.lunafaction_boots },
    { name: "mantle_of_battle_harmony", display: "Mantle of Battle Harmony", class: "warlock", subclass: ["all"], type: "Chestpiece", img: images.mantle_of_battle_harmony },
    { name: "necrotic_grip", display: "Necrotic Grip", class: "warlock", subclass: ["all"], type: "Gauntlets", img: images.necrotic_grip },
    { name: "nezarecs_sin", display: "Nezarec’s Sin", class: "warlock", subclass: ["all"], type: "Helmet", img: images.nezarecs_sin },
    { name: "nothing_manacles", display: "Nothing Manacles", class: "warlock", subclass: ["void"], type: "Gauntlets", img: images.nothing_manacles },
    { name: "ophidian_aspect", display: "Ophidian Aspect", class: "warlock", subclass: ["all"], type: "Gauntlets", img: images.ophidian_aspect },
    ...
    { name: "sanguine_alchemy", display: "Sanguine Alchemy", class: "warlock", subclass: ["all"], type: "Chestpiece", img: images.sanguine_alchemy },
    ...
    { name: "the_stag", display: "The Stag", class: "warlock", subclass: ["all"], type: "Helmet", img: images.the_stag },
    { name: "transversive_steps", display: "Transversive Steps", class: "warlock", subclass: ["all"], type: "Boots", img: images.transversive_steps },
    { name: "veritys_brow", display: "Verity’s Brow", class: "warlock", subclass: ["all"], type: "Helmet", img: images.veritys_brow },
    { name: "vesper_of_radius", display: "Vesper of Radius", class: "warlock", subclass: ["all"], type: "Chestpiece", img: images.vesper_of_radius },
    ...
    { name: "winters_guile", display: "Winter’s Guile", class: "warlock", subclass: ["all"], type: "Gauntlets", img: images.winters_guile },
  ]
}
